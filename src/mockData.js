...
export const planetRadiuses = {
  ...
  Venus: { radius: 6051.84, texture: `${basicPath}/8k_venus${extension}`},
  Earth: { radius:6378.137, texture: `${basicPath}/8k_earth${extension}`},
  ...
  Uranus: {radius:25559, texture: `${basicPath}/8k_uranus${extension}`},
  Neptune: {radius:24766, texture: `${basicPath}/8k_neptune${extension}`},
